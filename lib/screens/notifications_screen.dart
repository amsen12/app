...
class NotificationsScreen extends StatelessWidget {
  ...
  Color _iconColor(AppNotification n) {
    if (n.title.contains('Accepted') || n.title.contains('Completed') || n.title.contains('Rating')) return AppTheme.success;
    if (n.title.contains('Way') || n.title.contains('Request')) return AppTheme.primary;
    if (n.title.contains('Rate')) return AppTheme.warning;
    return Colors.grey;
  }
}