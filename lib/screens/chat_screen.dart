        ...
        title: Row(
          ...
          children: [
            ...
            CircleAvatar(
              ...
              child: Text(widget.otherUserName[0], style: const TextStyle(fontWeight: FontWeight.bold, color: ProfixColors.primary)),
            ...
            Column(
              ...
              children: [
                ...
                const Text('Online', style: TextStyle(fontSize: 11, color: ProfixColors.green)),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isOwn ? ProfixColors.primary : Colors.white,
      ...
      child: SafeArea(
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(icon: const Icon(Icons.location_on_outlined, color: ProfixColors.primary), onPressed: () => _sendLocation(app)),
